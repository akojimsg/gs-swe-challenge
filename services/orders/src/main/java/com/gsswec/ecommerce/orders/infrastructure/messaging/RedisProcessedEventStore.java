...
// SETNX-backed dedupe ledger. TTL bounds storage growth — far longer than any
// redelivery window, short enough to not accumulate forever.
@Component
public class RedisProcessedEventStore implements ProcessedEventStore {

    private static final String KEY_PREFIX = "orders:processed:";
